    ...
    public class CommunicationServiceClient : ICommunicationService
    {
        ...
        public CommunicationServiceClient()
        {
            ...
            while (_client.CommunicationState != CommunicationStates.Connected)
            {
                ...
                {
                    Logger.Log.Error(Language.Instance.GetMessageFromKey("RETRY_CONNECTION"), ex);
                    System.Threading.Thread.Sleep(1000);
                }
            }
        }
        ...
        public static CommunicationServiceClient Instance => _instance ??= new CommunicationServiceClient();
        ...
        public void Reset()
        {
            _instance = new CommunicationServiceClient();
        }

        public int GetTotalSessions() => _client.ServiceProxy.GetTotalSessions();
        ...
        public void Shutdown(string worldGroup, short time) => _client.ServiceProxy.Shutdown(worldGroup, time);
        ...
        internal void OnShutdown(short time) => ShutdownEvent?.Invoke(time, null);
