...
namespace OpenNos.DAL.Interface
{
    public interface IGeneralLogDAO
    {
        ...
        DeleteResult Delete(IEnumerable<long> ids);

        GeneralLogDTO Insert(GeneralLogDTO generalLog);

        SaveResult Insert(IEnumerable<GeneralLogDTO> generalLog);

        SaveResult InsertOrUpdate(GeneralLogDTO generalLog);

        SaveResult InsertOrUpdate(IEnumerable<GeneralLogDTO> logs);
