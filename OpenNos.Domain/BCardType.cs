...
namespace OpenNos.Domain
{
    public static class BCardType
    {
        ...
        public enum CardType : short
        {
            ...
            // ??? = 90~104,
            EnemyElementResistancePercent = 94,
            GiveBuff = 95,

            PixieCostumeWings = 96,

            IncreaseDamageElement = 98,
            ...
            GetInDodge = 110,
            BonusBCards = 200,
            BigCashMoneyBCards = 234,

            // CUSTOM NOSMOON
            Recover = 1000,
            OnAttackRestore = 1001,
            ChanceChangeResistance = 1002
        }
    ...
    {
        public enum ChanceChangeResistance : short
        {
            AllIncreased = 11,
            AllDecreased = 12,
            FireIncreased = 21,
        ...
        public enum OnAttackRestore : short
        {
            RestoreHP = 11,
            RestoreMP = 21,
            RestoreHPPercentage = 31,
            RestoreMPPercentage = 41
        }

        public enum Recover : short
        {
            RecoverHP = 11,
            RecoverMP = 21,
            RecoverHPPercent = 31,
        ...
        public enum BigCashMoneyBCards
        {
            IncreaseDropPercentage = 10
        }

        public enum BonusTitleBCards
        {
            IncreaseGoldEarned = 10,
            ShineBrightLikeADiamond = 20,
            InstantBattleAFKPower = 30,
            IncreaseRaidBoxDropChance = 40,
            IncreaseReputationPercent = 50,
        }
        ...
        public enum ReverteDamage : short
        {
            ByPercent = 11,
        ...
        public enum GiveBuff : short
        {
            GiveBuffToEntity = 21,
        }

        public enum DealMoreDamage : short
        {
            IncreaseDamage = 11,
        ...
        public enum IncreaseDamageVsChar : short
        {
            IncreaseDamagePercent = 11,
            DecreaseDamagePercent = 12,
            IncreaseCACDamage = 21,
            IncreaseRangedDamage = 31,
            IncreaseMagicalDamage = 41,
        }

        public enum SpawnEqMonster : short
        {
            Deal50PercentDamage = 11,
        }

        public enum IncreaseDamageVsEntity : short
        {
        ...
        public enum IncreaseDamageVsFaction : short
        {
        ...
        public enum IncreaseDamageVsMonsterInMap : short
        {
        ...
        public enum IncreaseSlPoint : short
        {
            IncreaseDamage = 11,
            IncreaseDefence = 21,
            IncreaseEllement = 31,
        ...
        // 1-20
        public enum SpecialAttack : short
        {
            NoAttack = 11,
            NoAttackNegated = 12,
            MeleeDisabled = 21,
        ...
        public enum SpecialDefence : short
        {
        ...
        public enum SpecialCritical : short
        {
            AlwaysInflict = 11,
        ...
        public enum IncreaseDamage : short
        {
        ...
        public enum DodgeAndDefencePercent : short
        {
            DodgeIncreased = 11,
            DodgeDecreased = 12,
        ...
        public enum ElementResistance : short
        {
            AllIncreased = 11,
            AllDecreased = 12,
            FireIncreased = 21,
        ...
        public enum ElementResistancePercent : short
        {
            AllIncreased = 11,
            AllDecreased = 12,
            FireIncreased = 21,
        ...
        public enum EnemyElementResistance : short
        {
            AllIncreased = 11,
            AllDecreased = 12,
            FireIncreased = 21,
        ...
        public enum EnemyElementResistancePercent : short
        {
            AllIncreased = 11,
            AllDecreased = 12,
            FireIncreased = 21,
        ...
        public enum GuarantedDodgeRangedAttack : short
        {
        ...
        public enum DrainAndSteal : short
        {
            ReceiveHpFromMP = 11,
        ...
        public enum HealingBurningAndCasting : short
        {
            RestoreHP = 11,
            DecreaseHP = 12,
            RestoreMP = 21,
        ...
        public enum SpecialisationBuffResistance : short
        {
        ...
        public enum SpecialEffects : short
        {
            DecreaseKillerHP = 11,
            IncreaseKillerHP = 12,
        ...
        public enum Capture : short
        {
            CaptureAnimal = 11,
            CaptureAnimalNegated = 12
        }

        public enum SpecialDamageAndExplosions : short
        {
            ChanceExplosion = 11,
        ...
        public enum SpecialEffects2 : short
        {
            FocusEnemy = 11,
        ...
        public enum CalculatingLevel : short
        {
        ...
        public enum TimeCircleSkills : short
        {
            GatherEnergy = 11,
        ...
        public enum RecoveryAndDamagePercent : short
        {
        ...
        public enum Count : short
        {
            Summon = 11,
            SummonChance = 12,
            DecreaseCriticalDmg = 42
        }

        public enum NoDefeatAndNoDamage : short
        {
        ...
        public enum SpecialActions : short
        {
            PushBack = 11,
            PushBackNegated = 12,
            FocusEnemies = 21,
        ...
        public enum NoCharacteristicValue : short
        {
        ...
        public enum LightAndShadow : short
        {
        ...
        public enum DebuffResistance : short
        {
        ...
        public enum Quest : short
        {
            SummonMonsterBased = 11,
            SummonMonsterBasedNegated = 12
        }

        public enum SecondSPCard : short
        {
            PlantBomb = 11,
        ...
        public enum SPCardUpgrade : short
        {
            LowerSPScroll = 11,
        ...
        public enum BossMonstersSkill : short
        {
            InflictDamageAfter = 11,
            InflictDamageAfterNegated = 12
        }

        public enum LordHatus : short
        {
            InflictDamageAtLocation = 11,
            InflictDamageAtLocationNegated = 12
        }

        public enum LordCalvinas : short
        {
            InflictDamageAtLocation = 11,
            InflictDamageAtLocationNegated = 12
        }

        public enum SESpecialist : short
        {
        ...
        public enum InflictSkill : short
        {
            InflictDamageAtLocation = 11,
            InflictDamageAtLocationNegated = 12
        }

        public enum HideBarrelSkill : short
        {
            NoHPConsumption = 11,
            NoHPRecovery = 12
        }

        public enum FocusEnemyAttentionSkill : short
        {
        ...
        public enum FireCannoneerRangeBuff : short
        {
            AOEIncreased = 11,
            AOEDecreased = 12,
            Flinch = 21,
        ...
        public enum VulcanoElementBuff : short
        {
            SkillsIncreased = 11,
            SkillsDecreased = 12,
        ...
        public enum DamageConvertingSkill : short
        {
        ...
        public enum MeditationSkill : short
        {
            CausingChance = 11,
            RemovingChance = 12,
            ShortMeditation = 21,
        ...
        public enum AbsorptionAndPowerSkill : short
        {
            AddDamageToHP = 11,
            ...
            CritDamagetoHeal = 61,
            LeechHpFromEnemy = 71,
            StealPercentageHpFromEnemy = 81,
        }

        public enum LeonaPassiveSkill : short
        {
            IncreaseDamageAgainst = 11,
        ...
        public enum SniperAttack : short
        {
            ChanceCausing = 11,
            ChanceRemoving = 12,
        ...
        public enum FrozenDebuff : short
        {
            EternalIce = 11,
        ...
        public enum JumpBackPush : short
        {
            JumpBackChance = 11,
        ...
        public enum FairyXPIncrease : short
        {
        ...
        public enum SummonAndRecoverHP : short
        {
            ChanceSummon = 11,
        ...
        public enum TeamArenaBuff : short
        {
        ...
        public enum DarkCloneSummon : short
        {
        ...
        public enum AbsorbedSpirit : short
        {
        ...
        public enum MeteoriteTeleport : short
        {
        ...
        public enum EffectSummon : short
        {
            // TODO
            LastSkillReset = 11,
        ...
        public enum PixieCostumeWings : short
        {
            IncreaseFairyElement = 21,
        }

        public enum DragonSkills : short
        {
            Transformation = 11,
        ...
        public enum LotusSkills : short
        {
            ChangeMoonSkills = 31,
            ChangeLotusSkills = 41
        }

        public enum WolfMaster : short
        {
        ...
        public enum PvpFairyEffect : short
        {
            IncreaseDamageVsDemons = 5,
            IncreaseDamageVsAngels = 4
        }

        public enum UpdateChampionExp : short
        {
            IncreaseChampionExp = 21
        }
