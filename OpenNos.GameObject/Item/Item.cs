...
namespace OpenNos.GameObject
{
    public abstract class Item : ItemDTO
    {
        ...
        public byte IsSecondarySp()
        {
            if (ItemType != ItemType.Specialist)
            {
                return 0;
            }

            return (byte)(MorphSp == 1 || MorphSp == 8 || MorphSp == 9 || MorphSp == 16 || MorphSp == 32 || MorphSp == 35 || MorphSp == 36 || MorphSp == 38 ? 1 : 0);
        }
