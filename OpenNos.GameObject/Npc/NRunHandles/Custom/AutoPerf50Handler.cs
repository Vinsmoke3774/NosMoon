...
{
    [NRunHandler(NRunType.AutoPerf50)]
    public class AutoPerf50Handler : SpecialHandlerBase, IGenericHandler<NRunPacket>
    {
        public AutoPerf50Handler(ClientSession session) : base(session)
        {
        }
        ...
        public void Execute(NRunPacket packet)
        {
            ...
            specialist.MultiplePerfection(Session, 50);
        }
    }
}
