...
{
    [NRunHandler(NRunType.ExchangeForMagicCamel)]
    public class ExchangeForMagicCamelHandler : SpecialHandlerBase, IGenericHandler<NRunPacket>
    {
        public ExchangeForMagicCamelHandler(ClientSession session) : base(session)
        {
        }
