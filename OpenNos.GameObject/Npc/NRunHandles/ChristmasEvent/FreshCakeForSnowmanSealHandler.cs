...
{
    [NRunHandler(NRunType.ExchangeForChristmasSnowmanRaidSeal)]
    public class FreshCakeForSnowmanSealHandler : SpecialHandlerBase, IGenericHandler<NRunPacket>
    {
        public FreshCakeForSnowmanSealHandler(ClientSession session) : base(session)
        {
        }
