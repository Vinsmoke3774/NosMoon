...
{
    [NRunHandler(NRunType.ExchangeForSealedChristmasVessel2)]
    public class ChocolateCakeForSealedVesselHandler : SpecialHandlerBase, IGenericHandler<NRunPacket>
    {
        public ChocolateCakeForSealedVesselHandler(ClientSession session) : base(session)
        {
        }
