...
{
    [NRunHandler(NRunType.ExchangeForChristmasSnowmanRaidSeal2)]
    public class ChocolateCakeForSnowmanSealHandler : SpecialHandlerBase, IGenericHandler<NRunPacket>
    {
        public ChocolateCakeForSnowmanSealHandler(ClientSession session) : base(session)
        {
        }
