...
namespace OpenNos.GameObject.Event
{
    public static class CaligorRaid
    {
        ...
        public static void Run()
        {
            ...
            Observable.Timer(TimeSpan.FromMinutes(0)).SafeSubscribe(X => raidThread.Run());
        }
    ...
    public class CaligorRaidThread
    {
        ...
        public void Run()
        {
            ...
            CaligorRaid.CaligorMapInstance.IsPVP = false;
            CaligorRaid.UnknownLandMapInstance.IsPVP = false;
            ...
            {
                //new EventContainer(CaligorRaid.CaligorMapInstance, EventActionType.SENDPACKETAFTER, "msg 0 King of the Hill will begin in 5 minutes", 60000),
                //new EventContainer(CaligorRaid.CaligorMapInstance, EventActionType.SENDPACKETAFTER, "msg 0 King of the Hill will begin in 1 minute", 240000),
                new EventContainer(CaligorRaid.CaligorMapInstance, EventActionType.SENDPACKETAFTER, "msg 0 King of the Hill has begun", 0),
                new EventContainer(CaligorRaid.CaligorMapInstance, EventActionType.SENDPACKETAFTER, "qnamli 4 #guri^3000 2303 0 0 0", 0),
                new EventContainer(CaligorRaid.CaligorMapInstance, EventActionType.SCRIPTEND, (byte)1),
                new EventContainer(CaligorRaid.CaligorMapInstance, EventActionType.ENABLEPVP, new object()),
                new EventContainer(CaligorRaid.UnknownLandMapInstance, EventActionType.ENABLEPVP, new object()),
            };
