...
namespace OpenNos.Core.Networking.Communication.Scs.Communication.Messengers
{
    ...
    /// operation. It extends RequestReplyMessenger. It is suitable to use in applications those
    /// want to receive messages by synchronized method calls instead of asynchronous
