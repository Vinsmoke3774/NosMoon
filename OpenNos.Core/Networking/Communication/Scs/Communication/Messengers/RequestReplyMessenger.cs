...
namespace OpenNos.Core.Networking.Communication.Scs.Communication.Messengers
{
    ...
    public class RequestReplyMessenger<T> : IMessenger, IDisposable where T : IMessenger
    {
        ...
        /// <summary>
        /// This event is raised when a new message is sent without any error. It does not
        /// guaranties that message is properly handled and processed by remote application.
        /// </summary>
        ...
        /// </summary>
        /// <remarks>
        /// Response message is matched with RepliedMessageId property, so if any other message
        /// (that is not reply for sent message) is received from remote application, it is not
        /// considered as a reply and is not returned as return value of this method.
        ///
