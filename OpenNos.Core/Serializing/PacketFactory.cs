...
namespace OpenNos.Core
{
    public static class PacketFactory
    {
        ...
        public static PacketDefinition Deserialize(string packetContent, Type packetType, bool includesKeepAliveIdentity = false)
        {
            ...
            {
                Logger.Logger.Log.Error($"The serialized packet has the wrong format. Packet: {packetContent}", ex);
                return null;
            }
        }
            ...
            where TPacket : PacketDefinition
        {
            ...
            {
                Logger.Logger.Log.Error($"The serialized packet has the wrong format. Packet: {packetContent}", e);
                return null;
            }
        }
        ...
        public static string Serialize<TPacket>(TPacket packet) where TPacket : PacketDefinition
        {
            ...
            {
                Logger.Logger.Log.Error("Wrong Packet Format!", e);
                return "";
            }
        }
