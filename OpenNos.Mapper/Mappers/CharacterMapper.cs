...
namespace OpenNos.Mapper.Mappers
{
    public static class CharacterMapper
    {
        ...
        public static bool ToCharacter(CharacterDTO input, Character output)
        {
            ...
            output.HatInVisible = input.HatInVisible;
            output.LockInterface = input.LockInterface;
            ...
            output.LastSave = input.LastSave;
            output.RP = input.RP;
            output.SkyTowerLevel = input.SkyTowerLevel;
            output.BattlePassPoints = input.BattlePassPoints;
            output.HavePremiumBattlePass = input.HavePremiumBattlePass;
            output.AliveCountdown = input.AliveCountdown;
