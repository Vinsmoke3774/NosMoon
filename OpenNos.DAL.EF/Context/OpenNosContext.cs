...
namespace OpenNos.DAL.EF
{
    public class OpenNosContext : DbContext
    {
        ...
        public OpenNosContext() : base("Data Source=localhost;Initial Catalog=opennos;Integrated Security=true")
        {
        ...
        public virtual DbSet<CharacterTimespaceLog> CharacterTimespaceLog { get; set; }
        ...
        public virtual DbSet<MimicRotation> MimicRotation { get; set; }
        ...
        public virtual DbSet<TitleLog> TitleLogs { get; set; }

        public virtual DbSet<TwoFactorBackup> TwoFactorBackups { get; set; }

        public virtual DbSet<InstantBattleLog> InstantBattleLogs { get; set; }

        public virtual DbSet<RefreshToken> RefreshTokens { get; set; }

        public virtual DbSet<TitleWearConditionEntity> TitleWearCondition { get; set; }

        public virtual DbSet<LevelUpRewardEntity> LevelUpRewards { get; set; }

        public virtual DbSet<WhitelistedPlayerEntity> WhitelistedPlayers { get; set; }

        public virtual DbSet<CharacterSkyTower> CharacterSkyTower { get; set; }

        public virtual DbSet<BattlePassItem> BattlePassItems { get; set; }

        public virtual DbSet<BattlePassPalier> BattlePassPaliers { get; set; }

        public virtual DbSet<BattlePassQuest> BattlePassQuest { get; set; }

        public virtual DbSet<BattlePassItemLogs> BattlePassItemLogs { get; set; }

        public virtual DbSet<BattlePassQuestLogs> BattlePassQuestLogs { get; set; }
        
        public virtual DbSet<FishInfo> FishInfo { get; set; }

        public virtual DbSet<FishingLog> FishingLog { get; set; }
