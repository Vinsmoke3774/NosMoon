...
namespace OpenNos.DAL.EF
{
    public class Character
    {
        ...
        public Character()
        {
            ...
            CharacterSkyTower = new List<CharacterSkyTower>();
        }
        ...
        public bool HatInVisible { get; set; }
        ...
        public virtual ICollection<CharacterSkyTower> CharacterSkyTower { get; set; }
        ...
        public int SkyTowerLevel { get; set; }

        public int BattlePassPoints { get; set; }

        public bool HavePremiumBattlePass { get; set; }

        public double AliveCountdown { get; set; }
